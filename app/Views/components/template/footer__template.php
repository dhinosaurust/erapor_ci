<footer class="container-fluid border-top">
    <div class="row justify-content-between p-3">
        ...
        <div class="col-6 m-3 text-white d-flex justify-content-center flex-column">
            <ul class="list-unstyled p-3">
                <li class="mb-3">BKPSDM Kota Surabaya</li>
                <li class="mt-2"><i class="bi bi-pin-map-fill me-3"></i>Jl. Jimerto No.25-27 LT. III R.24, Ketabang, Surabaya</li>
                <li class="mt-2"><i class="bi bi-telephone me-3"></i>(031) 5466484</li>
                <li class="mt-2"><i class="bi bi-envelope-at-fill me-3"></i>bkpsdm@surabaya.go.id</li>
            </ul>
        </div>    
    </div>
</footer>