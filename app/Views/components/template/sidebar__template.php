<aside id="sideNav" class="d-flex flex-column flex-shrink-0 p-3" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item">
            <a href="kuesioner" class="nav-link p-3 mt-3 text-white <?= strpos($_SERVER['REQUEST_URI'], '/kuesioner') === 0 ? 'active' : ''; ?>" aria-current="page">
                <i class="bi bi-pencil-square me-2"></i>
                <span class="d-none d-sm-inline">Kuesioner</span>
            </a>
        </li>
        <li class="nav-item">
